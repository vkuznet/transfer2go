...
CREATE TABLE REQUESTS(id INTEGER PRIMARY KEY, rid TEXT, lfn TEXT, block TEXT, dataset TEXT, srcurl TEXT, srcalias TEXT, dsturl TEXT, dstalias TEXT, regurl TEXT, regalias TEXT, status TEXT, priority INTEGER);
